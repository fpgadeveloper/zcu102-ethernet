...
* RJ45 port : `XPAR_XEMACPS_3_BASEADDR`
* SFP cage 0: `XPAR_AXIETHERNET_0_BASEADDR`

##### BSP Setting

* When using the SFP ports, the BSP setting "use_axieth_on_zynq" must be set to 1.
* When using the RJ45 port, the BSP setting "use_axieth_on_zynq" must be set to 0.
